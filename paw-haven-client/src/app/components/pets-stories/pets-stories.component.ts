...
@Component({
  selector: 'app-pets-stories',
  standalone: true,
  imports: [CommonModule, RouterModule, PawLoaderComponent],
  templateUrl: './pets-stories.component.html',
  styleUrl: './pets-stories.component.scss'
})
export class PetsStoriesComponent implements OnInit {
  blogPosts: BlogPost[] = [];
  ...
  loadMockData(): void {
    // Створюємо мокові категорії блогу
    this.categories = [
      { id: 1, name: 'Догляд за тваринами', iconUrl: 'assets/icons/hurt.svg', postsCount: 12 },
      { id: 2, name: 'Здоров\'я', iconUrl: 'assets/icons/pet-health.svg', postsCount: 8 },
      { id: 3, name: 'Тренування', iconUrl: 'assets/icons/training.svg', postsCount: 6 },
      { id: 4, name: 'Історії порятунку', iconUrl: 'assets/icons/rescue.svg', postsCount: 10 },
      { id: 5, name: 'Поради', iconUrl: 'assets/icons/tips.svg', postsCount: 14 }
    ];

    // Створюємо мокові пости для блогу
    this.blogPosts = [
      {
        id: 1,
      ...
      },
      {
        ...
        `,
        imageUrl: 'assets/images/blog/dogs.jpg',
